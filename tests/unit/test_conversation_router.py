...
class TestConversationRouter:
    ...
    @pytest.mark.asyncio
    async def test_conversation_returns_200(self):
    ...
    @pytest.mark.asyncio
    async def test_conversation_returns_404_for_missing_lesson(self):
    ...
    @pytest.mark.asyncio
    async def test_conversation_accepts_history(self):
    ...
    @pytest.mark.asyncio
    async def test_conversation_validates_request(self):
