<span id="page-99-0"></span>**LESSON 13**

# **Past Experiences**

**OBJETIVO: APRENDERÉ A NARRAR EXPERIENCIAS PASADAS.**
...
Aprende el significado y la pronunciación de cada palabra antes de ir a tu grupo de conversación. Intenta usar las palabras. Mantén una conversación con alguien que sepa inglés o envía un mensaje a un amigo de tu grupo de EnglishConnect usando las palabras nuevas.

| husband          | esposo                         |
|------------------|--------------------------------|
| wife             | esposa                         |
| spouse           | cónyuge                        |
| When did you … ? | ¿Cuándo (verbo en<br>pasado)…? |
| What happened?   | ¿Qué ocurrió?                  |

### **Verbs** Present/Verbs Past**

| become/became parents       | convertirse/convertido en<br>padres         |
|-----------------------------|---------------------------------------------|
| begin/began a job           | comenzar/comenzado un<br>trabajo            |
| finish/finished high school | terminar/terminado la<br>escuela secundaria |

| get/got a new job                    | conseguir/conseguido un<br>nuevo trabajo |
|--------------------------------------|------------------------------------------|
| get/got married                      | casarse/casado                           |
| go/went to school                    | ir/ido a la escuela                      |
| graduate/graduated                   | graduarse/graduado                       |
| have/had a baby                      | tener/tenido un bebé                     |
| have/had a challenging<br>experience | tener/tenido una<br>experiencia difícil  |
| lose/lost a job                      | perder/perdido un trabajo                |
| meet/met a friend                    | encontrarse/encontrado<br>con un amigo   |
| move/moved                           | mudarse/mudado                           |
| quit/quit my job                     | dejar/dejado mi trabajo                  |
| save/saved money                     | ahorrar/ahorrado dinero                  |
| start/started a business             | iniciar/iniciado un negocio              |
| travel/traveled to<br>New York       | viajar/viajado a Nueva York              |
| turn 18/turned 18*                   | cumplir/cumplido 18 años                 |
|                                      |                                          |

<sup>\*</sup> Nota: Utiliza *turn* o *turned* para hablar de la edad. En la lección 11 y la lección 12 puedes ver más *past-tense verbs*.
...
| Escribe cuatro preguntas que puedas hacerle a<br>alguien. Escribe la respuesta a cada pregunta. Léelas<br>en voz alta. |  |
|------------------------------------------------------------------------------------------------------------------------|--|
|                                                                                                                        |  |
|                                                                                                                        |  |
|                                                                                                                        |  |
...
Fíjate en las ilustraciones y haz y responde preguntas sobre las experiencias de cada persona. ¡Sé creativo! Tomen turnos.

#### **New Vocabulary**

| buy/bought a car     | comprar/comprado<br>un auto |
|----------------------|-----------------------------|
| go/went to the beach | ir/ido a la playa           |
| university           | universidad                 |

**Example: Sara**

#### **Image 1: graduate Image 2:**
...
**Image 1: turn 20 Image 2: travel to another country**

![](_page_105_Picture_5.jpeg)

**Ji Ah**

**Image 1: turn 26 Image 2: have a baby**
...
Haz y responde preguntas sobre acontecimientos importantes en tu vida. Puedes hablar de los acontecimientos importantes de la lista o pensar en otros acontecimientos. Di todo lo que puedas. Tomen turnos.

#### **New Vocabulary**

| rent/rented an apartment | alquilar/alquilado un<br>apartamento |
|--------------------------|--------------------------------------|
| What did you do then?    | ¿Qué hiciste entonces?               |
