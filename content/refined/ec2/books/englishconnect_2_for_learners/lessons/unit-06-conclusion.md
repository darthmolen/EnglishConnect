<span id="page-192-0"></span>**UNIT 6: CONCLUSION**

# **Describing Special Occasions**

¡Felicitaciones! Terminaste EnglishConnect 2. Ahora puedes conversar con hablantes de inglés acerca de una variedad de temas. Continúa aprendiendo siempre y utiliza lo que has aprendido para mejorar tu vida y la de otras personas. A medida que sigas aprendiendo por el estudio y por la fe, el Señor te bendecirá.
...
• _es: Describir mis metas futuras.

![](_page_192_Picture_17.jpeg)

![](_page_192_Picture_18.jpeg)

![](_page_192_Picture_19.jpeg)
...
Continúa practicando inglés a diario conforme te preparas para EnglishConnect 3.
...
#### <span id="page-193-0"></span>**APPENDIX**
...
| stepmother (stepmom)/<br>stepmothers   | madrastra/madrastras                   |
| mother-in-law/<br>mothers-in-law       | suegra/suegras                         |
| father (dad)/fathers                   | padre (papá)/padres                    |
| stepfather (stepdad)/<br>stepfathers   | padrastro/padrastros                   |
| father-in-law/<br>fathers-in-law       | suegro/suegros                         |
| parent/parents                         | padre o madre/los padres<br>(ambos)    |
| sister/sisters                         | hermana/hermanas                       |
| stepsister/stepsisters                 | hermanastra/<br>hermanastras           |
| brother/brothers                       | hermano/hermanos                       |
| stepbrother/stepbrothers               | hermanastro/<br>hermanastros           |
| daughter/daughters                     | hija/hijas                             |
| sibling/siblings                       | hermano/hermanos (de<br>ambos sexos)   |
| son/sons                               | hijo/hijos                             |
| child/children                         | niño/niños                             |
| grandmother (grandma)/<br>grandmothers | abuela/abuelas                         |
| grandfather (grandpa)/<br>grandfathers | abuelo/abuelos                         |
| grandparent/<br>grandparents           | abuelo o abuela/los<br>abuelos (ambos) |
| aunt/aunts                             | tía/tías                               |
...
| eye/eyes           | ojo/ojos                     |
| finger/fingers     | dedo/dedos (de las<br>manos) |
| foot/feet          | pie/pies                     |
...
| toe/toes           | dedo/dedos (de los pies)     |
...
| Subject<br>Pronoun<br>Pronombre<br>personal | Object<br>Pronoun<br>Pronombre de<br>objeto | Possessive<br>Adjective<br>Adjetivo<br>posesivo |
|---------------------------------------------|---------------------------------------------|-------------------------------------------------|
| Example:<br>I am happy.                     | Example:<br>Ann is bigger<br>than me.       | Example:<br>My name is Tom.                     |
| I                                           | me                                          | my                                              |
| you                                         | you                                         | your                                            |
| we                                          | us                                          | our                                             |
| he                                          | him                                         | his                                             |
...
#### <span id="page-196-0"></span>**APPENDIX**
...
# <span id="page-196-1"></span>Questions (10–15 minutes)
...
![](_page_196_Picture_8.jpeg)

![](_page_196_Picture_9.jpeg)

- 2. Comparte tu respuesta con el grupo.
- 3. Tomen turnos para elegir preguntas y compartir las respuestas.
...
- Puedes usar estas preguntas con otros juegos, tales como "Cadena de bicicleta" o "Lanzar la pelota".

# <span id="page-197-0"></span>Hot Seat (10–20 minutes)
...
# <span id="page-197-1"></span>Ball Toss (10–15 minutes)
...
# <span id="page-198-0"></span>Give One, Get One (10–20 minutes)
...
# <span id="page-199-0"></span>Speculation—"I think that you …" (15–20 minutes)

#### **Steps**

- 1. Piensa en un verbo.
- 2. Dilo en voz alta.
- 3. Con el verbo, crea una oración cierta acerca de otro compañero. Para

![](_page_199_Picture_6.jpeg)

comenzar la oración, di: "Creo que tú…".
...
# <span id="page-199-1"></span>Tell Me a Story! (5–15 minutes)

#### **Steps**

- 1. Trabaja con un compañero o un grupo pequeño.
- 2. Una persona dice la primera oración de una historia inventada.
- 3. La persona siguiente dice la segunda oración.
- 4. Tomen turnos para decir una oración de la historia hasta terminarla.
...
- Creen grupos de tres a cinco personas.
- Esta actividad puede resultar más fácil si se muestra una imagen para iniciar la historia.
- Otra manera de hacer más fácil esta actividad consiste en que cada grupo comience con la misma oración. Por ejemplo, cada grupo podría comenzar con "Tuve un fin de semana terrible" o "Fue el mejor día de mi vida".

# <span id="page-200-0"></span>Two Truths and One Lie (10–15 minutes)
...
- 2. Lee tus afirmaciones en voz alta a un compañero o a un grupo pequeño de tres a cinco personas.
...
# <span id="page-200-1"></span>Vocabulary Cards (10–15 minutes)
...
- Esta es una excelente manera de practicar el vocabulario.
...
# <span id="page-201-0"></span>Dice Game 2 (10–15 minutes)

#### **Steps**

- 1. Necesitas dos dados (o tarjetas numeradas del 1 al 6).
- 2. Elige seis verbos y escríbelos en la pizarra; numéralos del 1 al 6.

![](_page_201_Picture_5.jpeg)

- 3. Elige otras palabras, pronombres o tiempos verbales y escríbelos en la pizarra; numéralos del 1 al 6.
- 4. Trabaja con un compañero o un grupo pequeño de tres a cinco personas. Tira los dados. Utiliza los dos números que aparezcan para crear una oración con las palabras correspondientes. Tomen turnos.

#### **Example**

El maestro escribe los siguientes verbos y tiempos verbales en la pizarra:
...
El alumno 1 tira los dados y obtiene 6 y 3. Luego crea una oración con *comprar* + *tiempo pasado*.

"I bought rice and chicken at the store last night."

La alumna 2 tira los dados y obtiene 4 y 6. Luego crea una oración con *reír* + *tiempo presente*.

"I always laugh at my dog. He's so silly".

El alumno 3 tira los dados y obtiene 1 y 5. Luego crea una oración con *comer* + *tiempo pasado*.

"I ate pizza for lunch."

#### **Notes**

- Esta es una buena manera de practicar los tiempos verbales (pasado, presente y futuro) u otras estructuras gramaticales (con el uso de antes y después, preguntas, enunciados negativos, etc.).
- Si se reúnen de forma virtual, trabajen con todo el grupo. Utilicen un dado virtual y tomen turnos para crear oraciones.

# <span id="page-201-1"></span>Bicycle Chain (in person) (10–20 minutes)
...
# <span id="page-202-0"></span>Mingle and Share (in person) (10–15 minutes)
...
Sara: I don't have a favorite song. I really like to

sing with other people.

Mei: What do you like to do?

Lee: I like to play video games. What do you like
...
Los alumnos comparten con el grupo lo que aprendieron.
...
#### <span id="page-203-0"></span>**APPENDIX**
...
| Modismo                                 | Definición                                                                                                       | Ejemplo                                                                                                     |
|-----------------------------------------|------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| a piece of cake                         | fácil                                                                                                            | That test was a<br>piece of cake!                                                                           |
| a blessing in<br>disguise               | algo bueno que<br>parece malo al<br>principio                                                                    | She lost her<br>job, but it was<br>a blessing in<br>disguise. She<br>found a better<br>job.                 |
| all in the same<br>boat                 | todos están<br>en la misma<br>situación                                                                          | Nobody can<br>leave this room.<br>We're all in the<br>same boat.                                            |
| barking up the<br>wrong tree            | tratar de lograr<br>algo, pero<br>hacerlo de<br>una manera<br>equivocada                                         | If you think<br>I'm going to<br>loan you more<br>money, you're<br>barking up the<br>wrong tree.             |
| better late than<br>never               | es mejor que<br>algo suceda<br>tarde que no                                                                      | A: He didn't<br>repay the money<br>until last week.                                                         |
|                                         | suceda nunca                                                                                                     | B: That's okay.<br>Better late than<br>never.                                                               |
| birds of a<br>feather flock<br>together | las personas con<br>personalidades,<br>actitudes,<br>intereses o<br>gustos similares<br>a menudo se<br>agrupan   | I was right<br>that Paul and<br>Ben would get<br>along. Birds of<br>a feather flock<br>together.            |
| no use crying<br>over spilled milk      | no sirve de nada<br>preocuparse<br>ni recordar<br>las cosas que<br>salieron mal<br>y que no se<br>pueden cambiar | We can't get the<br>money back,<br>so let's make a<br>new plan. It's no<br>use crying over<br>spilled milk. |

| Modismo                                                | Definición                                                                         | Ejemplo                                                                                                                                     |
|--------------------------------------------------------|------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| don't count your<br>chickens before<br>they're hatched | no estar seguro<br>de que algo vaya<br>a suceder, por<br>lo que no se              | A: I will probably<br>get a raise soon,<br>so I bought a<br>new bed!                                                                        |
|                                                        | debe planificar<br>nada al respecto<br>todavía                                     | B: Well, don't<br>count your<br>chickens before<br>they're hatched.<br>You might not<br>get the raise.                                      |
| get all your<br>ducks in a row                         | organizarlo todo<br>y prepararse<br>para el siguiente<br>paso                      | We have to get<br>all our ducks in<br>a row before the<br>family comes for<br>a visit. Let's start<br>cleaning and<br>cooking right<br>now. |
| give me a hand                                         | ayudarme                                                                           | I can't lift this<br>sofa on my own.<br>Can you give me<br>a hand?                                                                          |
| hang in there                                          | no rendirse                                                                        | I know learning<br>English is very<br>difficult. Hang in<br>there.                                                                          |
| it takes two to<br>tango                               | las dos personas<br>involucradas<br>en la acción<br>o el error son<br>responsables | It is partially my<br>fault that we<br>were fighting.<br>It takes two to<br>tango.                                                          |
| keep an eye on                                         | observar con<br>atención                                                           | My son<br>has been<br>misbehaving<br>a lot lately, so<br>please keep<br>an eye on him<br>to ensure that<br>nothing goes<br>wrong.           |

| Modismo                                       | Definición                                                                                                 | Ejemplo                                                                                                                                                       |
|-----------------------------------------------|------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| let the cat out of<br>the bag                 | revelar un<br>secreto de<br>manera<br>imprudente o<br>intencional                                          | I heard that<br>someone let the<br>cat out of the<br>bag, so I might<br>as well tell you<br>myself—I'm<br>pregnant!                                           |
| out of the frying<br>pan and into the<br>fire | pasar de una<br>mala situación<br>a una situación<br>todavía peor                                          | He didn't like his<br>previous job, so<br>he quit, but now<br>he can't find a<br>new job. He's<br>out of the frying<br>pan and into the<br>fire.              |
| go out on a limb                              | intentar algo<br>arriesgado que<br>podría ponerte<br>en una posición<br>más débil                          | I'm going to go<br>out on a limb<br>here and invest<br>some money<br>in this project,<br>even though I<br>don't know if the<br>project will be<br>successful. |
| preaching to the<br>choir                     | intentar<br>convencer a<br>alguien que ya<br>está de acuerdo<br>contigo                                    | They are already<br>going to vote for<br>him. He's just<br>preaching to the<br>choir.                                                                         |
| rub salt in the<br>wound                      | empeorar<br>la situación<br>haciendo que<br>la persona se<br>sienta culpable<br>o recordándole<br>su error | I know I<br>shouldn't have<br>done it. You<br>don't have to<br>remind me and<br>rub salt in the<br>wound.                                                     |
| so far, so good                               | hasta ahora, las<br>cosas van bien                                                                         | This first month,<br>they haven't had<br>any problems<br>building the<br>house. So far,<br>so good.                                                           |

| Modismo                                     | Definición                                                                                                                | Ejemplo                                                                                                                                                |
|---------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| the straw that<br>broke the<br>camel's back | un problema<br>pequeño que<br>tiene grandes<br>consecuencias<br>porque es el<br>último de varios<br>problemas<br>seguidos | We had a<br>terrible week.<br>Everything was<br>going wrong. So<br>when we missed<br>the bus, that<br>was the straw<br>that broke the<br>camel's back. |
| you're pulling<br>my leg                    | tratar de hacer<br>que alguien crea<br>algo incorrecto<br>de una manera<br>divertida;<br>engañarlo                        | No, that<br>celebrity isn't<br>calling me.<br>You're pulling<br>my leg.                                                                                |
...
#### <span id="page-206-0"></span>**APPENDIX**
...
**Biblia:** "La Biblia es un libro sagrado que contiene la palabra de Dios. A lo largo de sus páginas, la Santa Biblia enseña que Dios nunca deja de amar a Sus hijos. […] Seguir las enseñanzas que encontramos

en la Biblia nos ayuda a saber quién es Dios […] y entender mejor cómo quiere que vivamos.
...
#### <span id="page-210-0"></span>**APPENDIX**
...
| Hi. Can I ask you a<br>question? | Hola. ¿Puedo hacerte una<br>pregunta? |
...
| It was nice talking to you.<br>Bye! | Me dio gusto hablar<br>contigo. ¡Adiós! |
...
| Can you repeat that,<br>please?             | ¿Podrías repetir lo que<br>dijiste, por favor?    |
|---------------------------------------------|---------------------------------------------------|
| Can you speak slower,<br>please?            | ¿Podrías hablar más<br>despacio, por favor?       |
| Can you write that on the<br>board, please? | ¿Puedes escribir eso en la<br>pizarra, por favor? |
| How do you say          in<br>English?      | ¿Cómo se dice          en<br>inglés?              |
...
| Welcome!                    | ¡Bienvenidos!                      |
|-----------------------------|------------------------------------|
| Today is lesson 4.          | Hoy daremos la lección 4.          |
|                             |                                    |
| Begin.                      | Comienza.                          |
| Do it again.                | Hazlo de nuevo.                    |
| Look at pattern 2.          | Fíjate en el patrón 2.             |
| One more time.              | Una vez más.                       |
| Practice again.             | Practica de nuevo.                 |
| Practice with your partner. | Practica con tu<br>compañero.      |
| Read aloud.                 | Lee en voz alta.                   |
| Read the instructions.      | Lee las instrucciones.             |
| Repeat after me.            | Repite después de mí.              |
| Role-play.                  | Hagan dramatizaciones.             |
| Stand up.                   | Levántate.                         |
| Sit down.                   | Siéntate.                          |
| Stop.                       | Detente.                           |
| Switch partners.            | Cambien de compañero.              |
| Take turns.                 | Tomen turnos.                      |
| You have 10 minutes.        | Tienen 10 minutos.                 |
| Any questions?              | ¿Alguna pregunta?                  |
| Are you ready?              | ¿Están listos?                     |
| Remember to study.          | Recuerden que deben<br>estudiar.   |
| See you next week!          | ¡Nos vemos la semana<br>que viene! |
|                             |                                    |
|                             |                                    |

![](_page_212_Picture_0.jpeg)

#### <span id="page-212-0"></span>**APPENDIX**
